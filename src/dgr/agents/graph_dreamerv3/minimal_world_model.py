...
def init_params(
    key: jax.Array,
    config: MinimalWorldModelConfig,
...
def predict_next_nodes_single(
    ...
    h = jax.nn.relu(_message_passing_nodes(h, senders, receivers, node_mask, edge_mask))
    ...
    dyn_h = jax.nn.relu(_message_passing_nodes(dyn_h, senders, receivers, node_mask, edge_mask))
